...
export default class Delivery extends Component {
  ...
  state = {
    ...
    columns: [
      ...
      {title: '过账客户', dataIndex: 'post', align: 'center'},
      {title: '收入完结客户', dataIndex: 'done', align: 'center'},
      {title: '进行中客户', dataIndex: 'working', align: 'center'},
      {title: '坏账客户', dataIndex: 'bad', align: 'center'},
  ...
  render () {
    ...
    return (
      <div className='trech-wrap'>
        <div className='wrap-title'>交付信息</div>
