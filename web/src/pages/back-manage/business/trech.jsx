...
export default class Trech extends Component {
  ...
  state = {
    ...
    data: [],
    columns: [
      {title: '类别名称', dataIndex: 'name', align: 'center'},
      {title: '签约数量', dataIndex: 'count', align: 'center', render: text => `${text}个`},
      {title: '签约合同额', dataIndex: 'constract', align: 'center', render: text => `${text}万`},
  ...
  render () {
    ...
    return (
      <div className='trech-wrap'>
        <div className='wrap-title'>渠道签约</div>
